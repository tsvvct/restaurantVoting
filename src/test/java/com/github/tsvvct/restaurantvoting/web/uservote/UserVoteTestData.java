...
public class UserVoteTestData {
    public static final MatcherFactory.Matcher<UserVoteTo> USER_VOTE_TO_MATCHER = MatcherFactory.usingEqualsComparator(UserVoteTo.class);

    public static final int USER_VOTE1_ID = 1;

    public static final LocalDate testDate = LocalDate.now();

    public static final UserVoteTo userVote1 = new UserVoteTo(USER_VOTE1_ID, USER_ID,
            RestaurantTestData.RESTAURANT1_ID, testDate.minusDays(1));
    public static final UserVoteTo userVote2 = new UserVoteTo(USER_VOTE1_ID + 1, USER_ID,
            RestaurantTestData.RESTAURANT2_ID, testDate);
    ...
    public static UserVoteTo getUpdatedPrevious() {
        return new UserVoteTo(USER_VOTE1_ID, USER_ID, RestaurantTestData.RESTAURANT1_ID, testDate);
    }
}
